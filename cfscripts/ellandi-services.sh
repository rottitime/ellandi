...
buckets=(
    i-dot-ai-organogram-${CF_SPACE}
)

autoscalers=(
    scale-ellandi-api-${CF_SPACE}
    scale-organogram-${CF_SPACE}
    scale-ellandi-${CF_SPACE}
)

dbs=(
    organogram-postgres-${CF_SPACE}
    ellandi-postgres-${CF_SPACE}
)
...
printf "Checking ellandi services in the ${CF_SPACE} environment... \n "
