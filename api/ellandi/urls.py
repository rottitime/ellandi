...
api_urlpatterns = [
    ...
    path("me/skills-develop/", me_skills_develop_view, name="me-skills-dev"),
    path("me/skills/<str:skill_id>/", me_skill_delete_view, "me-skill-delete"),
    path("me/languages/<str:language_id>/", me_language_delete_view, name="me-language-delete"),
    path("me/skills-develop/<str:skill_develop_id>/", me_skill_develop_delete_view, name="me-skill-develop"),
