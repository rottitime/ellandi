...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='EmailSalt',
            fields=[
                ('email', ellandi.registration.models.LowercaseEmailField(max_length=254, primary_key=True, serialize=False, unique=True, verbose_name='email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line_manager_email', ellandi.registration.models.LowercaseEmailField(blank=True, max_length=128, null=True)),
                ...
                ('email', ellandi.registration.models.LowercaseEmailField(max_length=254, unique=True, verbose_name='email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='skills_develop', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(blank=True, choices=[('Beginner', 'Beginner'), ('Advanced beginner', 'Advanced beginner'), ('Competent', 'Competent'), ('Proficient', 'Proficient'), ('Expert', 'Expert')], max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(blank=True, max_length=127, null=True)),
                ('speaking_level', models.CharField(blank=True, choices=[('Basic', 'Basic'), ('Independent', 'Independent'), ('Proficient', 'Proficient'), ('None', 'None')], max_length=127, null=True)),
                ('writing_level', models.CharField(blank=True, choices=[('Basic', 'Basic'), ('Independent', 'Independent'), ('Proficient', 'Proficient'), ('None', 'None')], max_length=127, null=True)),
