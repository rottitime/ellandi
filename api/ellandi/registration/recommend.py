...
def recommend_relevant_user_skills(skills_list, job_title):
    """Given a list of user skills and a job title, and returns a random selection
    of recommendations, by combining recommendations based on title and each individual skill into a bundle
