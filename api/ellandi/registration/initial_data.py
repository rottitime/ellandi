...
DDAT_SKILLS_TO_JOB_LOOKUP = {
    ...
    "Analysis and synthesis": ["User researcher"],
    ...
    "Bridging the gap between the technical and non-technical": ["Technical architect"],
    ...
    "Coding and scripting": ["Infrastructure operations engineer"],
    "Commercial management": ["Delivery manager", "Programme delivery manager"],
    "Communicating analysis and insight": ["Performance analyst"],
    "Communicating information": ["Frontend developer", "Graphic designer", "Interaction designer", "Service designer"],
    "Communication skills": ["Data analyst", "Delivery manager", "Programme delivery manager"],
    "Communication skills (data)": ["Data engineer", "Data architect"],
    ...
    "Design secure systems": ["Security architect"],
    ...
    "Experience of using tools and software": ["Graphic designer"],
    "Experience of working within constraints": ["Product manager", "Interaction designer", "Service designer"],
    ...
    "Governance": ["Technical architect"],
    "Governance and assurance": ["Network architect"],
    "Incident management": [
    ...
    "Problem ownership": ["Product manager", "Service owner"],
    "Problem resolution (data)": ["Data engineer", "Data architect"],
    "Problem solving": ["Infrastructure engineer"],
    "Product ownership": ["Product manager", "Service owner"],
    ...
    "Research skills": ["User researcher"],
    "Service focus": [
        "Business relationship manager",
        "Change and release manager",
        "Command and control centre manager",
    ...
    "Specific security technology and understanding": ["Security architect"],
    "Stakeholder relationship management": ["Business analyst", "Content strategist", "Technical writer"],
    "Stakeholder relationship management (content design)": ["Content designer"],
    "Statistical methods and data analysis": ["Data scientist"],
    ...
    "Systems design": ["Frontend developer", "Infrastructure engineer", "Network architect"],
    "Systems integration": ["Frontend developer", "Infrastructure engineer"],
    ...
    "Technical specialism": ["End user computing engineer", "Infrastructure operations engineer"],
    "Technical understanding": [
        "Business relationship manager",
        "Change and release manager",
        "Command and control centre manager",
    ...
    "Technical understanding (infrastructure engineer)": ["Infrastructure engineer"],
    ...
    "Testing": ["Data engineer", "End user computing engineer", "Infrastructure operations engineer"],
