...
const PrivacyPage = () => (
  <>
    ...
    <Typography gutterBottom>
      ...
      be transferred and stored securely outside the European Economic Area. Where that is
      the case it will be subject to equivalent legal protection through the use of Model
      Contract Clauses.
    </Typography>
    ...
    <Typography gutterBottom>
      The contact details for the lead data controller's Data Protection Officer are: Data
      Protection Officer
      <br />
      Cabinet Office
      <br />
